...
<x-app-layout>
    <x-slot name="header">
     ...
     {{ 'Posts' }}
            ...
            <a href="{{ route('posts.create') }}" class="bg-blue-500 text-black px-4 py-2 rounded-md">ADD</a>
     </div>
     </x-slot>
     <div class="py-12">
     ...
     <a href="{{ route('posts.show', $post->id) }}" class="border border-blue-500 hover:bg-blue-500 hover:text-white
    px-4 py-2 rounded-md">SHOW</a>
     <a href="{{ route('posts.edit', $post->id) }}" class="border border-yellow-500 hover:bg-yellow-500 hover:textwhite px-4 py-2 rounded-md">EDIT</a>
